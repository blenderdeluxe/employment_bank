    ...
    <div id="edu_details" class="col-md-12 aug_group">
      ...
      <div class="_details">
          <div class="form-group aug-form-group-sm col-md-4">
              ...
              {!! Form::text('employers_name[]', '', ['class'=>'employers_name form-control', 'required']) !!}
          </div>

          <div class="form-group aug-form-group-sm col-md-4">
              <label for="post_held" class="control-label"> Post Held :</label>
              {!! Form::text('post_held[]', '', ['class'=>'post_held form-control', 'required']) !!}
          </div>

          <div class="form-group aug-form-group-sm col-md-4">
              <label for="year_experience" class="control-label">Year of Experience :</label>
              {!! Form::number('year_experience[]', '', ['class'=>'year_experience form-control', 'required', 'maxlength'=>'2']) !!}
          </div>
          <div class="form-group aug-form-group-sm col-md-4">
              <label for="salary" class="control-label">Salary :</label>
              {!! Form::text('salary[]', '', ['class'=>'salary form-control']) !!}
          </div>
          <div class="form-group aug-form-group-sm col-md-4">
